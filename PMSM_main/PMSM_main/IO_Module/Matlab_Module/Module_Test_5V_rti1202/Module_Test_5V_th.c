/************************ dSPACE target specific file *************************
   ...
   Include file .\Module_Test_5V_rti1202\Module_Test_5V_th.c :

   Task Configuration file for model : Module_Test_5V

   RTI1202 7.15 (02-Nov-2020)/2.20
   10-Jun-2024 11:21:27
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\Module_Test_5V_rti1202\Module_Test_5V_th.c is for ST).
# endif
