...
MAKEFILE                       = PMSM_DemoBackup.mk
BUILDARGS                      =  EXTMODE_STATIC_ALLOC=0 TMW_EXTMODE_TESTING=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTID01EQ=1"
MATLAB_ROOT                    = C:\Program Files\MATLAB\R2020a
MATLAB_BIN                     = C:\Program Files\MATLAB\R2020a\bin
MATLAB_ROOT_ALT                = C:\PROGRA~1\MATLAB\R2020a
MATLAB_BIN_ALT                 = C:\PROGRA~1\MATLAB\R2020a\bin
RELEASE_VERSION                = R2020a
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN64
MODEL                          = PMSM_DemoBackup
MODULES                        = PMSM_DemoBackup_data.c PMSM_DemoBackup_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
    "$(START_DIR)" \
    "$(START_DIR)\PMSM_DemoBackup_rti1202" \
